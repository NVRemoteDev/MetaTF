...
exports.index = function(req, res, next) {
  ...
  if(action === 'updateSchema') {
    require('../models/download_schema_model').download(req, res, next); // Downloads and writes schema
    ...
    require('../models/download_schema_model').resizeitems(req, res, next); // Downloads and writes schema
